...
def inception_resnet_v1_base(inputs,
                             final_endpoint='Mixed_8b',
                             output_stride=16,
  ...
  Constructs an Inception Resnet v1 network from inputs to the given final
  ...
  with tf.variable_scope(scope, 'InceptionResnetV1', [inputs]):
    with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
      ...
      #35 x 35 x 256
      net = slim.conv2d(net, 256, 3, stride = 2, padding=padding,
                        scope='Conv2d_4b_3x3')
      if add_and_check_final('Conv2d_4b_3x3', net): return net, end_points
      ...
      if add_and_check_final('Mixed_6b', net): return net, end_points
      ...
      if add_and_check_final('Mixed_8a', net): return net, end_points

      net = block8(net, activation_fn=None)
      if add_and_check_final('Mixed_8b', net): return net, end_points
...
def inception_resnet_v1(inputs, num_classes=1001, is_training=True,
  ...
  with tf.variable_scope(scope, 'InceptionResnetV1', [inputs],
    ...
    with slim.arg_scope([slim.batch_norm, slim.dropout],
      ...
      net, end_points = inception_resnet_v1_base(inputs, scope=scope,
...
def inception_resnet_v1_arg_scope(
